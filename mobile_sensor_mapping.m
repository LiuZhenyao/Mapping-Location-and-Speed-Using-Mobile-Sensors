%% Acquire GPS Data from Your Android(TM) Device and Plot Your Location and Speed on a Map
%
% This example shows how to collect position data from an Android device 
...
% turned on. If enabled on an Android device's location settings, mobile 
